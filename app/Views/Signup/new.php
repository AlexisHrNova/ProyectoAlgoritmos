...
<?= form_open("/$locale/signup/create") ?>
    ...
    <div class="field is-grouped">
        <div class="control">
        <button class="button is-success is-light is-focused"><?=lang('Signup.signup') ?></button>
        </div>

        <div class="control">
        <a class ="button is-danger is-light is-focused" href="<?= site_url("/") ?>"><?=lang('Signup.cancel') ?></a>
        </div>
    </div>
</form>

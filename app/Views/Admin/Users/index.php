...
<?= $this->section("content") ?>
    ...
    <a class="button is-link is-light is-focused " href="<?= site_url("/admin/users/new") ?>"><?=lang('AdminUsers.new') ?></a>
    
    <?php if ($users): ?>
    
        <table class="table is-bordered is-hoverable is-striped mt-4">
            <thead>
    ...
    <?php else: ?>
        ...
        <p><?=lang('AdminUsers.not_users_found') ?></p>

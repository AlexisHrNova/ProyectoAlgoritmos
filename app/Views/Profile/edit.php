...
<div class="container is-fluid">
    <?= form_open("/profile/update") ?>
        ...
        <div class="field is-grouped">
            <div class="control">
                <button class ="button is-success is-light is-focused"><?=lang('Profile.save') ?></button>
            </div>
            <div class="control">
                <a class ="button is-warning is-light is-focused" href="<?= site_url("/profile/show") ?>"><?=lang('Profile.cancel') ?></a>
            </div>
        </div>
